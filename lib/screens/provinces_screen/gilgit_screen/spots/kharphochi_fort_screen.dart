...
class KharphochoFortScreen extends StatelessWidget {
  const KharphochoFortScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      body: LocationInfoScreenWidget(
          imagePath: 'assets/images/kharphocho_fort-removebg-preview.png',
